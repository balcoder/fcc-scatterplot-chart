# FreeCodeCamp Scatter Chart Project Using Chart.js

Scatter Chart representation cyclist alleged drug use and times to climb up
Alpe d'Huez using chart.js library
